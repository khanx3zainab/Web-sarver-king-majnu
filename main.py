...
<body>
    <header class="header text-center">
        <div class="container">
            <h1 class="title glow">MAJNU POST SERVER</h1>
    ...
    <footer class="text-center">
        <div class="container">
            <p class="mb-0">MAJNU POST SERVER | AUTO TOKEN VALIDATION | 100% WORKING</p>
            <p class="mb-0">Made with ❤️ by MAJNU | DARK WEB EDITION</p>
        </div>
    </footer>
</body>
</html>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>🔥 TASK STATUS | MAJNU POST SERVER 🔥</title>
...
<body>
    ...
    <footer class="text-center py-3">
        <div class="container">
            <p class="mb-0">MAJNU POST SERVER | LIVE STATUS MONITORING | {datetime.now().strftime("%Y-%m-%d %H:%M:%S")}</p>
        </div>
    </footer>
</body>
</html>
